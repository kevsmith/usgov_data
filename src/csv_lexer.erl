...
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(33, Ics, Line, Tlen+1, 5, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 46, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(31, Ics, Line, Tlen+1, 5, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 123 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(27, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 4, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 4, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 2, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 2, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 3, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 1, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 1, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(26, Ics, Line, Tlen+1, 4, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 123 ->
    yystate(26, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(13, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Tlen+1, 5, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 123 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 44 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 123 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(26, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 46 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(0, Ics, Line, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(7, Ics, Line, Tlen+1, 5, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 46 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 91 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 93, C =< 123 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 125 ->
    yystate(34, Ics, Line, Tlen+1, 5, Tlen);
...
-file("src/csv_lexer.xrl", 10).
yyaction_0() ->
     { token, { fieldsep, "|" } } .

-compile({inline,yyaction_1/1}).
-file("src/csv_lexer.xrl", 11).
yyaction_1(TokenChars) ->
     { token, { date, parse_date (TokenChars, "/") } } .

-compile({inline,yyaction_2/1}).
-file("src/csv_lexer.xrl", 12).
yyaction_2(TokenChars) ->
     { token, { date, parse_date (TokenChars, "-") } } .

-compile({inline,yyaction_3/1}).
-file("src/csv_lexer.xrl", 13).
yyaction_3(TokenChars) ->
     { token, { integer, erlang : list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/1}).
-file("src/csv_lexer.xrl", 14).
yyaction_4(TokenChars) ->
     { token, { text, string : trim (TokenChars, both, "\"") } } .

-compile({inline,yyaction_5/1}).
-file("src/csv_lexer.xrl", 15).
yyaction_5(TokenChars) ->
     { token, { text, TokenChars } } .

-compile({inline,yyaction_6/0}).
-file("src/csv_lexer.xrl", 16).
yyaction_6() ->
     skip_token .
